...
// Set modifier callback (update functionafter modifier state changes)
...
// callback functionto call when this packet type is input
...
// callback  callback functionto apply to the field value, or undefined for no callback
//
...
// functionto close the controller object cleanly
...
// Register scaling functionfor a control name
...
// Lookup scaling functionfor control
// Returns undefined if functionis not registered.
...
// - Finally tries to run matching engine.setValue() functionfor buttons
...
//   Scaling functionfor encoders (isEncoder attribute is true) scales
//   field delta instead of raw value.
// - Calls callback functions for control fields, if defined for field
// - Finally tries run matching engine.setValue() functionfor control
...
HIDController.prototype.processControl = function(field) {
    ...
    if (field.isEncoder) {
        ...
        if (scaler != undefined) {
            ...
            // See the Traktor S4 script for how to use this.  If the scaler functionhas this
...
// you  are warned if following scaling functionnames are not registered:
//
// jog
//      Scaling functionfrom 'jog_wheel' for rate bend events with mixxx 'jog'
//      function. Should return value range suitable for 'jog', whatever you
//      wish it to do.
// jog_scratch
//      Scaling functionfrom 'jog_wheel' for scratch movements with mixxx
